...
- **Kit tagging folded into 0108** (post-apply review finding): the first generation tagged conversion-kit only where the review verdict said kit outright, missing the hedged creates (Hit and Run, Card Trix, Aquarium, ...) and the seeded IPDB models the page states "(kit for ...)" about (Tex-Op, Bowling, El Viti, El Tigre, New City, Grand Slam, Lido). gen.py now tags every kits-page create on the section's membership (hedges noted) and emits tag asserts for the quotable seeded models — all inside 0108 so the section reviews as one unit (patches after 0038, the last prod-ingested one, remain editable). Still untagged: seeded section members with neither statement nor certainty (Thrills, The Royal, Sky Devil's, Time Out, KO, Countdown, Big Sakem, Cosmos, Neptune, Arrow, Hot Bullet, Mini Flipper) — follow-up when their kit-ness is corroborated.
