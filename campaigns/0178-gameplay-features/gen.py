...
VOCAB_PATH = pk.PATCHES_DIR / "0178-gameplay-feature-vocab.yaml"
ASSIGN_PATH = pk.PATCHES_DIR / "0179-gameplay-features-ipdb.yaml"
...
def write_vocab() -> int:
    ...
    print(f"wrote {VOCAB_PATH.relative_to(pk.REPO_ROOT)} — {len(features)} features "
...
def write_assignments() -> None:
    ...
    print(f"wrote {ASSIGN_PATH.relative_to(pk.REPO_ROOT)} — {len(entries)} entries, "
